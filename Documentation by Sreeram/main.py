...
dates = [
         datetime.strptime('01-30-2022', '%m-%d-%Y').strftime("%B"),
...
def enter_estimate():
    driver.find_element_by_xpath(
        '//*[@id="__next"]/div[1]/div/div[2]/div/div[3]/div/div[1]/div[1]/div/div[3]/div[1]/div[4]/button').click()
    time.sleep(2)
    for i in range(1, 6):
        try:
            driver.find_element_by_xpath('/html/body/div[' + str(i) + ']/div/div/div[5]/button').click()
        except:
            print(i)
            i = 1
            time.sleep(2)
...
def save_data():
    ...
    df[['January_mean', 'January_median',
       'January_votes', 'February_mean', 'February_median', 'February_votes',
       'March_mean', 'March_median', 'March_votes', 'April_mean',
       'April_median', 'April_votes', 'May_mean',
       'May_median', 'May_votes','June_mean',
       'June_median', 'June_votes','crypto', 'current_date',
